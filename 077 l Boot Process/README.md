...
# :round_pushpin: Bootloader stage
 เป็นขั้นตอนสำคัญที่เตรียมฮาร์ดแวร์ ค้นหา และโหลดระบบปฏิบัติการ Bootloader ยอดนิยม ได้แก่ GRUB, LILO  ทำหน้าที่หลัก ดังนี้
...
POST (Power-On Self Test): BIOS ตรวจสอบฮาร์ดแวร์พื้นฐาน

Bootloader: โหลดเคอร์เนลเข้าสู่หน่วยความจำ
...
Init system: เริ่มต้นบริการระบบและโปรแกรมอื่นๆ

ระบบพร้อมใช้งาน: ผู้ใช้สามารถเข้าสู่ระบบและใช้งานโปรแกรมต่างๆ
...
Command ที่เกี่ยวข้องกับ Kernel stage ใน Linux
Command:
...
แสดงข้อความทั้งหมดที่เคอร์เนลส่งออก
ข้อความจะแสดงเรียงตามลำดับเวลา
ตัวอย่าง:
