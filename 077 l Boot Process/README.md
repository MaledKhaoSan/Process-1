...
2. Bootloader stage:
Bootloader stage เป็นขั้นตอนสำคัญที่เตรียมฮาร์ดแวร์ ค้นหา และโหลดระบบปฏิบัติการ Bootloader ยอดนิยม ได้แก่ GRUB, LILO  ทำหน้าที่หลัก ดังนี้
...
init 3: เริ่มต้นระบบใน multi-user mode
init 0: ปิดเครื่อง
init 6: รีบูตเครื่อง
