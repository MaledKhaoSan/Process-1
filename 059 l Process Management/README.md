...
<table width="100%" gap="30px">
    ...
    <tr>
      <td width="33%">`ps`</td>
      <td width="33%">แสดงรายการ process ทั้งหมด</td>
      <td width="33%">`ps aux`</td>
    </tr>
      <tr>
      <td width="33%">`kill`</td>
      <td width="33%">ยุติการทำงานของ process</td>
      <td width="33%">`kill -9 1234`</td>
    </tr>
      <tr>
	      <td width="33%">`renice`</td>
	      <td width="33%">เปลี่ยนระดับความสำคัญของ proces</td>
	      <td width="33%">`renice -n 10 1234`</td>
    </tr>
    <tr>
	<td width="33%">job controls</td>
        <td width="33%">ควบคุมการทำงานของ process ในรูปแบบ job</td>
        <td width="33%">`bg %1, fg %2`</td>
    </tr>
</table>
