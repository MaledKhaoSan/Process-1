...
เป็นขั้นตอนที่ให้โปรแกรมเริ่มต้นการทำงานใหม่เพื่อดำเนินการงานตามโค้ดที่กำหนด ภายในกระบวนการนี้มีหลายขั้นตอนที่สำคัญ
หลักการทำงาน:
1. การรันโปรแกรม:
   - ผู้ใช้สามารถรันโปรแกรมผ่าน command line หรือ graphical user interface (GUI).
   - เมื่อผู้ใช้รันโปรแกรม, ระบบปฏิบัติการจะสร้างกระบวนการใหม่เพื่อรันโปรแกรมนั้น.

2. การสร้างกระบวนการโดยระบบปฏิบัติการ:
   - ระบบปฏิบัติการสามารถสร้างกระบวนการใหม่ได้โดยตรง.
   - ตัวอย่างเช่นการเริ่มโปรแกรม daemon ที่ทำงานพื้นหลัง.
   - การตอบสนองต่อ events ต่างๆ เช่น การกดปุ่มบน keyboard.
