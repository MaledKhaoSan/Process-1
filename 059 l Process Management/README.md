...
การสร้างโปรแกรมใหม่ขึ้นมาเพื่อทำงานบนระบบ โดยระบบปฏิบัติการจะทำหน้าที่จัดสรรทรัพยากรที่จำเป็น เช่น หน่วยความจำและ CPU ให้กับโปรแกรมนั้น. โดยมักจะเกิดขึ้นเมื่อ
1. ผู้ใช้รันโปรแกรม:
